...
paper by allowing collaboration.
...
This removes output files after compilation. The flag -f is used to
avoid displaying error message if the output files do not exist.
